    ...
    @foreach($posts as $post)
       ...
       <td style="border-bottom:1px solid #563d7c70">
        ...
        <tr>
            ...
            <td width=100px><button type='submit' style='border:none;background-color:#563d7c80;border-radius:5px;width:80px'><a href="{{ route('posts.edit',['id'=>$post['id']]) }}" style="color: white">Edit</a></button></td>
            <td>
